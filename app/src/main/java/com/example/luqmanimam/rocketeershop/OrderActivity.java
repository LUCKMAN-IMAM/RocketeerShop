package com.example.luqmanimam.rocketeershop;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Jakarta'S cloth");
        mListMenu.add("Funny Cloth");//memasukan info ke spinner
